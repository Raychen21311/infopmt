...
ITEM_KEYWORDS = {
    # A 基本與前案
    "A0": ["案件性質", "開發建置", "系統維運", "功能增修", "套裝軟體", "硬體"],
    "A1": ["延續性", "前案", "採購簽陳", "影本", "合法性"],
    "A2.1": ["事前討論", "技術文件", "協助撰寫", "資訊處"],
    "A2.2": ["事前討論", "規劃階段", "會議紀錄", "採購內容"],
    "A2.3": ["請辦單", "契約書", "需求說明書", "檢視", "審閱期"],
    "A2.4": ["未討論", "無", "資訊處"],

    # B 現況說明
    "B1.1": ["架構圖", "網路架構", "硬體設備", "機房", "放置區域"],
    "B1.2": ["網路介接", "開發工具", "廠牌", "型號", "版本"],
    "B2": ["對外連線", "連線對象", "線路", "規格清單"],
    "B3": ["使用者", "使用機關", "示意圖", "說明"],
    "B4": ["網站網址", "最新版本", "網頁"],
    "B5": ["應用系統", "功能清單", "架構圖", "OS", "DB", "版本"],

    # C 資安需求
    "C1.1": ["資安", "個資保護", "安全等級", "核定等級"],
    "C1.2": ["資通系統防護基準", "SSDLC", "自評表", "分級辦法", "罰則"],
    "C1.3": ["RTO", "中斷時間", "最大可容忍", "服務水準"],
    "C1.4": ["SOC", "核心系統", "非機房", "納入範圍"],
    "C1.5": ["委外", "雲端", "合法性", "技術維運", "權利義務"],
    "C1.6": ["帳號密碼", "安全規範", "不得使用", "設計"],
    "C2.1": ["巨額", "資安採購", "高級安全", "安全軟體", "開發能力", "驗證"],
    "C2.2": ["專案管理", "資安專業認證", "至少一人"],
    "C2.3": ["技術人員", "網路安全", "訓練證書", "證照"],
    "C3.1": ["分包", "承包", "資安規定", "共同遵守"],
    "C3.2": ["分包", "基本資料", "服務建議書", "投標廠商"],
    "C4": ["不得採用", "大陸廠牌", "資通訊產品", "契約草案"],
    "C5": ["資通系統", "資安強化", "檢核表", "開發附表", "維運附表"],
    "C6": ["資料庫", "敏感資料", "加密技術", "採用", "規劃"],
    # D 作業需求
    "D1": ["軟硬體", "網路設備", "清單", "VM", "共用供應契約"],
    "D2": ["系統開發", "功能增修", "系統功能", "資料下載", "介接"],
    "D3": ["系統", "軟體", "相互關係", "利害關係人"],
    "D4": ["ODF", "文件下載", "格式"],
    "D5": ["App", "國發會", "規定", "附錄2"],
    "D6": ["App", "無障礙", "開發指引", "檢核表", "附錄3"],
    "D7": ["網站服務", "國發會", "管理規範", "檢核表", "附錄4"],
    "D8": ["OpenData", "MyData", "後續服務", "建議"],
    "D9": ["系統維護", "到場", "SLA", "績效指標", "滿意度調查"],
    "D10": ["履約服務", "契約期間", "銜接"],
    "D11": ["開發設備", "測試設備", "環境需求", "說明"],
    "D12": ["教育訓練", "客服服務", "需求"],
    "D13": ["保固服務", "期限", "範圍"],
    "D14": ["產品授權", "License", "需求"],
    "D15": ["虛擬化技術", "帳號清查", "登入登出", "異常紀錄", "資料異動", "政府資料標準"],
    "D16": ["GIS", "OPENDATA", "MYDATA", "TGOS", "EPSG", "GeoJSON"],
    "D17": ["需求訪談", "需求確認", "測試", "效能測試", "測試計畫", "測試報告"],
    "D18": ["醫療", "健康資料", "FHIR", "交換標準"],
    "D19": ["AI", "節省人力", "決策分析", "風險預警"],

    # E 產品交付
    "E1": ["交付時程", "開發方式", "瀑布", "敏捷"],
    "E2": ["交付品", "專案計畫", "需求設計", "測試計畫", "原始碼", "執行碼"],
    "E3": ["維護交付品", "執行計畫", "維護報告", "設計", "手冊", "原始碼"],
    "E4": ["再生測試", "開發工具", "驗證正確性", "原始程式碼", "執行碼"],
    "E5": ["網路設備", "驗收", "交付帳密", "設定檔", "規則列表", "架構"],

    # F 其他重點
    "F1": ["機房VM", "共用資料庫", "成本分攤", "經費"],
    "F2": ["經費預估", "合理性", "維運費用", "逐年遞減", "保固"],
    "F3": ["採購內容", "前後一致", "無不一致"],
    "F4": ["服務水準", "績效違約金", "契約書", "檢查"],
    "F5": ["履約標的", "契約書", "正確", "無缺漏"],
    "F6": ["系統介接", "同意", "確認", "經費來源"],
    "F7": ["硬體設備", "下架日期", "汰換", "不再使用"],
    "F8": ["最有利標", "評選項目", "配分", "附錄", "需求調整"]
}
...
16) 若 id = 'A0'，審查結果以預審表判定為主(******以業務單位需求為主***)。
