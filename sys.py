...
7) 若 id = 'A2.1、A2.2、A2.3'，若預審表為不適用，結果即為"不適用"，並回復"與資訊處之相關實務情形，請承辦人再次核實。"
8) 若 id = 'A2.4'，如果'A2.1、A2.2、A2.3' 接為"不適用"，'A2.4'結果應為符合。
9) 若 id = 'B1'，符合情形：有包含設備、網路、機房架構圖、有寫硬體放置區域為"衛生福利部外"或"衛生福利部內。
10) 若 id = 'B2'，符合情形：有包含網路架構圖，一般原則上均無對外連線之網路，架構圖接只畫出對內部線路圖。
11) 若 id = 'C1.5'，針對本項次內容***委外****指的是委託外部廠商，另外需求及契約書應有說明相關規範及需求，請看符不符合併說明。
